...
(comment
  (refresh "src/twgt/main.clj")
  (refresh "dev/make.clj")
  (refresh "src/twgt/cgi.clj")
  (refresh "src/twgt")
  (refresh "dev"))
...
(comment
  ;; Compile all .java files under src and place .class files in the same dir
  (javac)
  ;; comment
  )
